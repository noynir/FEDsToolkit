/*gulp hello, lint, config + styles, watch + clean, util+log,lazy,
/bable ,wiredep + inject, imagemin + copy, angular + minifyhtml, bundlein, filter+minify, versioning  */
...
gulp.task('inject',['styles','templates','es6'],function(){
